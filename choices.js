                  ...
                  options:{
                    ...
                    b:{
                      ...
                      options:{
                        ...
                        b:{
                          msg:"John is able to resist the powers of the Trident and brings back the Trident to the museum. Dirk is promptly arrested by authorities and John saves the world from the clutches of his father and refuses to buy another pack of Trident again.",
        ...
        b:{
          ...
          options:{
            ...
            b:{
              ...
              options:{
                a:{
                  msg:"John goes to his father and asks about why is he looking for the Trident. John's father looked very confused and asks John what the hell is he on about. John apologies to his father and walks back to his office in the museum. As he is walking away, John's father pulls out a gun and shoots John in the back, killing him.",
                  info:"Confront your father about the Trident",
                },
                b:{
                  msg:"John follows his father very carefully, trying not to get caught. He follows him to the bathroom, where he then pressed the urinal flush buttons in a weird order and opens a hidden passageway. John became very concern that his father may be an enemy. After a few minutes, the secret door opened again and John's father exits the bathroom. John, still hiding, is able to avoid his father's detection and enters the bathroom. John enters the secret pass code and enters the hidden passageway. Inside, he walks down some stairs until he can see light coming from underneath a door.",
                  info:"Follow your father",
                  options:{
                    a:{
                      msg:"John continues on forward and opens the door. Inside, was a small room filling with thousands of documents dating back as far as the ancient Greeks. Every single one of these documents had one common thing: the Trident. He couldn't believe that his father, a shoemaker was actually an evil mastermind in disguise. He looked at a drawing board and sees many photos with their face crossed out and sees his own with no crosses. He also checks the computer on his desk for more information and discovers there were more than one Trident in the world, but actually 4. John is shocked with this knowledge and realizes the door was opening and out came his father. John was quick and grabbed a stapler and smashed his father in the head with the stapler. John then decides to call the authorities and arrested his father and ended his quest in finding the Trident.",
                      info:"Continue forward"
                    },
                    b:{
